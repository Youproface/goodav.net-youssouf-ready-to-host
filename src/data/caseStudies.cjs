...
exports.getCaseStudyById = exports.getFeaturedCaseStudies = exports.caseStudies = void 0;
exports.caseStudies = {
    'gilead-ias-2025': {
        id: 'gilead-ias-2025',
        slug: 'gilead-ias-2025',
        title: 'Full Media Coverage of IAS 2025',
        ...
        testimonial: {
            text: 'A huge thank you to you and the team, Youssouf. I\'ve seen some of the initial edits — they are fantastic. Clients are thrilled.',
            author: 'Michelle',
            role: 'Creative Lead, Bensimon Byrne'
        }
    },
    'snv-clean-cooking': {
        id: 'snv-clean-cooking',
        slug: 'snv-clean-cooking',
        title: 'Clean Cooking Initiative Documentary',
        description: 'Documenting the transformation of communities through clean cooking solutions across Rwanda',
        location: 'Rwanda',
        tags: ['Documentary', 'Environmental', 'Social Impact', 'Community Stories'],
        content: {
            overview: 'SNV Netherlands Development Organisation partnered with GoodAV to create a compelling documentary showcasing how clean cooking solutions are transforming lives, climate, and communities in Rwanda. The project documented the distribution of 44,000 improved cookstoves and their impact on local communities.',
            challenge: 'Capturing authentic stories across multiple rural communities while demonstrating the environmental and social impact of clean cooking initiatives in a way that resonates with both local and international audiences.',
        ...
        testimonial: {
            text: 'The documentary effectively showcased the transformative impact of our clean cooking initiative, helping us communicate the scale and importance of this work to stakeholders worldwide.',
            author: 'Project Director',
            role: 'SNV Clean Cooking Initiative'
        }
    },
    'biomex-uvu-bio': {
        id: 'biomex-uvu-bio',
        slug: 'biomex-uvu-bio',
        title: 'BioMex x UVU-Bio Partnership',
        description: 'Professional documentation of cutting-edge biotech training, showcasing the transformative power of hands-on education in Rwanda\'s emerging biotechnology sector',
        location: 'Kigali, Rwanda',
        tags: ['Documentary', 'Education', 'Biotechnology', 'Training', 'Workforce Development'],
        content: {
            overview: 'GoodAV partnered with Zentrum für Fernstudien im Hochschulverbund through the BioMex Project (facilitated by GIZ) to create a compelling cinematic documentary showcasing the BioMex upskilling program at UVU-Bio Laboratories in Kigali. The project highlighted practical biotechnology training and its impact on Rwanda\'s emerging biotech workforce through professional storytelling and authentic participant experiences.',
            challenge: 'Creating a compelling narrative that effectively showcases the value of biotechnology education while capturing authentic student experiences and demonstrating the practical impact of hands-on training in a laboratory setting.',
        ...
        testimonial: {
            text: 'I like the storytelling and the shooting angles as well as the well-organized and performed interviews — very professional!',
            author: 'Tina Simon',
            role: 'Marketing and Social Media, BioMex'
        }
    },
    'undp-youth-cafe': {
        id: 'undp-youth-cafe',
        slug: 'undp-youth-cafe',
        title: 'The Youth Cafe | UNDP',
        description: 'Comprehensive video production showcasing youth empowerment initiatives through education, entrepreneurship, and community engagement in collaboration with UNDP',
        location: 'Kigali, Rwanda',
        tags: ['Video Production', 'Youth Empowerment', 'Non-profit', 'B2B', 'B2C', 'International'],
        youtubeUrl: 'https://www.youtube.com/watch?v=a0GyLzJrVTM',
        content: {
            overview: 'The video titled "The Youth Cafe | UNDP" highlights the impactful work of The Youth Cafe in collaboration with the United Nations Development Programme (UNDP). It showcases various initiatives aimed at empowering youth through education, entrepreneurship, and community engagement. The video features interviews with young leaders, project highlights, and success stories that demonstrate the positive impact of these programs on the lives of young people. GoodAV had the privilege of editing and shooting this video, ensuring that it effectively conveys the inspiring work being done by The Youth Cafe and UNDP.',
            challenge: 'Producing a video that effectively captures the impact of The Youth Cafe\'s collaboration with UNDP posed several challenges: representing diverse youth experiences accurately, balancing inspiration with information while showcasing success stories and providing insights into specific initiatives, communicating the scale and breadth of programs without losing individual stories, and maintaining audience engagement throughout multiple interviews and project highlights with dynamic pacing.',
            solution: 'GoodAV\'s full-scale production and editing services ensured a compelling and dynamic video through personalized storytelling with carefully selected youth leaders and success stories, smooth integration of interviews with dynamic visuals of youth in action, effective pacing and editing with fast-paced transitions to maintain viewer interest, and highlighting key initiatives using visual overlays, motion graphics, and project sequences to ensure audience understanding while maintaining personal storytelling.',
        ...
        image: '/images/all_site_images/Portfolio/undp-youth-cafe.jpg',
        date: 'June 2024 - ongoing',
        client: 'United Nations Development Programme (UNDP)',
        category: 'Video Production',
        testimonial: {
            text: 'GoodAV delivered a high-quality, dynamic video that perfectly captured our mission and the transformative power of youth empowerment initiatives.',
            author: 'Program Director',
            role: 'The Youth Cafe & UNDP'
        }
    },
    'aspire-programme-year-three': {
        id: 'aspire-programme-year-three',
        slug: 'aspire-programme-year-three',
        title: 'Post-Production for ASPIRE Programme Year Three Documentary',
        description: 'Comprehensive post-production services for a documentary celebrating three years of community-led peacebuilding initiatives across Rwanda',
        location: 'Kigali, Nyagatare, Huye – Rwanda',
        tags: ['Post-Production', 'Documentary', 'Peacebuilding', 'Voice-Over', 'Animation', 'Social Impact'],
        content: {
            overview: 'The ASPIRE Programme—Action for Sustainable Peace, Inclusion, Rights, and Equality—has been implemented across Rwanda for three years, promoting community-led peacebuilding through education, empowerment, and inclusion. To document and celebrate its Year 3 achievements, Aegis Trust partnered with GoodAV to deliver professional post-production services for a 15–20-minute documentary film. The goal: create a compelling and emotionally resonant piece for donor reporting, stakeholder engagement, and public inspiration.',
            challenge: 'Creating a compelling narrative from raw footage that would serve multiple purposes—donor reporting, stakeholder engagement, and public inspiration—while maintaining cultural sensitivity and humanitarian values. The project required rapid turnaround with professional broadcast-quality standards and multi-platform optimization.',
    ...
    'kwibuka30-rwanda-despair-to-hope': {
        ...
        testimonial: {
            text: 'GoodAV delivered a masterful tribute that perfectly captured our nation\'s journey from despair to hope, honoring our history while celebrating our remarkable transformation.',
            author: 'Ministry Representative',
            role: 'Ministry of National Unity & Civic Engagement'
        }
    },
    'rssb-mou-signing': {
        id: 'rssb-mou-signing',
        slug: 'rssb-mou-signing',
        title: 'RSSB MoU Signing with Ministry of Health, IRCAD AFRICA and King Faisal Hospital',
        description: 'Professional video production documenting the strategic partnership signing between major healthcare institutions to enhance medical services and training in Rwanda',
        location: 'Kigali, Rwanda',
        tags: ['Corporate Event', 'Government', 'Healthcare', 'B2B', 'B2C', 'National', 'Institutional Partnership'],
        youtubeUrl: 'https://www.youtube.com/watch?v=O-bQXQctLJk',
        content: {
            overview: 'The video titled "RSSB signed an MoU with the Ministry of Health, IRCAD AFRICA and King Faisal Hospital Rwanda" captures the signing of a Memorandum of Understanding between the Rwanda Social Security Board (RSSB), the Ministry of Health, IRCAD Africa, and King Faisal Hospital Rwanda. The video highlights key moments from the event, including speeches and the formal signing ceremony. It emphasizes the significance of this partnership in enhancing healthcare services and medical training in Rwanda. GoodAV provided comprehensive production services from shooting to editing.',
            challenge: 'Capturing the significance of a high-level MoU signing event required overcoming several key challenges: conveying the strategic importance of the agreement between major institutions and clearly communicating how the partnership would enhance healthcare services and medical training, maintaining engagement in a formal ceremonial event by requiring creative editing and storytelling for broader audience appeal, balancing speeches with visual storytelling to blend key figures\' statements with compelling visuals, and ensuring high production quality that was polished, professional, and aligned with the prestige of the organizations involved.',
        ...
        testimonial: {
            text: 'GoodAV delivered exceptional production quality that perfectly captured the significance of our healthcare partnership, enhancing the visibility and impact of this important institutional collaboration.',
            author: 'Communications Director',
            role: 'Rwanda Social Security Board (RSSB)'
        }
    },
    'alu-africa-business-heroes-2023': {
        id: 'alu-africa-business-heroes-2023',
        slug: 'alu-africa-business-heroes-2023',
        title: 'Africa\'s Business Heroes (ABH) 2023 Recap Video',
        description: 'High-energy recap video showcasing the prestigious entrepreneurship competition featuring ten African business leaders competing for USD 1.5 million in grant funding',
        location: 'Kigali, Rwanda',
        tags: ['Event Recap', 'Education', 'Entrepreneurship', 'B2B', 'B2C', 'Regional', 'Competition', 'Business'],
        youtubeUrl: 'https://www.youtube.com/watch?v=5Cjbze8jBIA',
        content: {
            overview: 'The video titled "Africa\'s Business Heroes (ABH) 2023 RECAP VIDEO" highlights the impactful work of the Africa\'s Business Heroes Prize competition. It showcases key moments from the event, including inspiring speeches, engaging panel discussions, and vibrant cultural performances. The video features the ten "business heroes" from across Africa who competed for their share of USD 1.5 million in grant funding. It also highlights the exclusive access participants had to training, mentoring, and networking opportunities. GoodAV provided comprehensive production services from shooting to editing.',
            challenge: 'Producing a high-energy, engaging recap video for ABH 2023 presented several key challenges: condensing a multi-day event into a captivating story by carefully selecting the most powerful and inspiring moments from numerous speeches, panel discussions, and cultural performances, highlighting the entrepreneurs\' journey by effectively showcasing ten diverse business leaders\' unique stories while maintaining smooth narrative flow, capturing the energy and emotion of the event by balancing professionalism with excitement to convey competition spirit, mentorship, and networking energy, and ensuring high-quality, dynamic editing that was polished, fast-paced, and engaging for online audiences across various platforms.',
        ...
        testimonial: {
            text: 'GoodAV delivered an exceptional recap video that perfectly captured the energy and impact of Africa\'s Business Heroes, helping us showcase the transformative power of African entrepreneurship to a global audience.',
            author: 'Event Director',
            role: 'African Leadership University (ALU)'
        }
    },
    'aims-research-innovation-centre': {
        id: 'aims-research-innovation-centre',
        slug: 'aims-research-innovation-centre',
        title: 'AIMS Research and Innovation Centre',
        description: 'Compelling documentary showcasing groundbreaking mathematical research and innovation at the African Institute for Mathematical Sciences, highlighting Africa\'s growing role in global scientific research',
        location: 'Africa',
        tags: ['Documentary', 'Research', 'Innovation', 'Mathematical Sciences', 'Education', 'B2B', 'B2C', 'Academic'],
        youtubeUrl: 'https://www.youtube.com/watch?v=m7sO3bIu-3U',
        content: {
            overview: 'The video titled "AIMS Research and Innovation Centre" showcases the groundbreaking work being done at the African Institute for Mathematical Sciences (AIMS) Research and Innovation Centre. It highlights key projects, innovative research, and the impact of AIMS on the scientific community in Africa. The video features interviews with researchers, demonstrations of cutting-edge technology, and insights into the future of mathematical sciences on the continent. GoodAV provided comprehensive production services from shooting to editing.',
            challenge: 'Producing a compelling video that effectively communicates the significance of mathematical research and innovation in Africa presented several key challenges: translating complex research into an engaging story by making highly abstract and technical mathematical sciences visually engaging and easily understood by a broad audience, showcasing the real-world impact by going beyond academic discussions to highlight how AIMS\' research drives innovation and solves real-world challenges in Africa, seamless integration of interviews and demonstrations by structuring cohesive narrative balancing researcher interviews with captivating visuals of research projects and technology demonstrations, and maintaining high production quality ensuring crisp visuals, clear audio, and dynamic pace to keep audiences engaged.',
        ...
        testimonial: {
            text: 'GoodAV masterfully translated our complex mathematical research into an engaging visual narrative that effectively communicates AIMS\' impact on African scientific innovation to both academic and general audiences.',
            author: 'Research Director',
            role: 'African Institute for Mathematical Sciences (AIMS)'
        }
    },
    'rwanda-rising-cimerwa-documentary': {
        id: 'rwanda-rising-cimerwa-documentary',
        slug: 'rwanda-rising-cimerwa-documentary',
        title: 'Rwanda Rising: The Cimerwa Documentary',
        description: 'Comprehensive documentary showcasing Cimerwa\'s role in Rwanda\'s industrial transformation and infrastructure development',
        location: 'Rwanda',
        tags: ['Documentary', 'Industrial', 'Infrastructure', 'B2B', 'B2C', 'Manufacturing', 'Economic Development'],
        content: {
            overview: 'Rwanda Rising: The Cimerwa Documentary captures the remarkable story of Cimerwa Plc and its pivotal role in Rwanda\'s industrial transformation. The documentary highlights the company\'s contribution to infrastructure development, economic growth, and the nation\'s vision for industrialization. Through compelling visuals and expert interviews, the film showcases how Cimerwa has become a cornerstone of Rwanda\'s construction industry and economic development.',
            challenge: 'Creating a compelling documentary that effectively communicates Cimerwa\'s industrial impact while maintaining audience engagement presented several challenges: translating complex industrial processes into visually engaging content accessible to both B2B and B2C audiences, showcasing the company\'s role in national development while maintaining commercial appeal, balancing technical information with human interest stories, and demonstrating the connection between industrial growth and Rwanda\'s broader transformation narrative.',
        ...
        testimonial: {
            text: 'GoodAV delivered an exceptional documentary that perfectly captured Cimerwa\'s role in Rwanda\'s industrial transformation, showcasing our contribution to national development with professional excellence.',
            author: 'Communications Director',
            role: 'CIMERWA Plc'
        }
    },
    'gilead-short-form-content': {
        id: 'gilead-short-form-content',
        slug: 'gilead-short-form-content',
        title: 'Gilead Short-Form Content Series',
        description: 'Dynamic short-form video content for social media platforms showcasing pharmaceutical innovation and health advocacy',
        location: 'Kigali, Rwanda',
        tags: ['Short-Form Content', 'Social Media', 'Pharmaceutical', 'B2B', 'B2C', 'Health Advocacy', 'YouTube Shorts'],
        youtubeUrls: [
            'https://www.youtube.com/shorts/HgPGMQuZMn0',
            'https://www.youtube.com/shorts/CsdRr8Fvt2g',
            'https://www.youtube.com/shorts/g2c7_dcluY8'
        ],
        content: {
            overview: 'The Gilead Short-Form Content Series represents a collection of dynamic, engaging videos created for social media platforms, particularly YouTube Shorts. These videos showcase pharmaceutical innovation, health advocacy initiatives, and key moments from Gilead\'s global health programs. The content is designed to maximize engagement across digital platforms while maintaining compliance with pharmaceutical industry standards.',
            challenge: 'Creating compelling short-form content for a pharmaceutical company presented unique challenges: condensing complex health and pharmaceutical information into engaging 60-second formats, maintaining regulatory compliance while creating shareable social content, balancing educational value with entertainment to maximize social media engagement, and ensuring consistent brand messaging across multiple short-form videos while keeping each piece unique and compelling.',
        ...
        testimonial: {
            text: 'GoodAV\'s short-form content perfectly balances our pharmaceutical compliance requirements with engaging social media content that resonates with our diverse audiences.',
            author: 'Digital Marketing Manager',
            role: 'Gilead Sciences'
        }
    },
    'plus-life-media-ias-2025': {
        id: 'plus-life-media-ias-2025',
        slug: 'plus-life-media-ias-2025',
        title: 'Global HIV Coverage with Plus Life Media at IAS 2025',
        description: 'International media partnership providing comprehensive production support for U.S.-based health media platform at the 13th IAS Conference on HIV Science in Kigali',
        location: 'Kigali, Rwanda',
        tags: ['International Partnership', 'Health Media', 'Conference Coverage', 'B2B', 'Production Support', 'Accreditation Management'],
        youtubeUrls: [
            'https://www.youtube.com/watch?v=8pVeNupGtI8&t=316s',
            'https://www.youtube.com/watch?v=wpYU4WelU0Y',
            'https://www.youtube.com/watch?v=Ge26tZmJRQ0&t=149s',
            'https://www.youtube.com/watch?v=uWzSA73tp9k&t=51s'
        ],
        content: {
            overview: 'When Plus Life Media, a U.S.-based health media platform known for its strong HIV advocacy work, needed a reliable, on-the-ground audiovisual team for the IAS 2025 conference in Kigali, they partnered with GoodAV to provide full production support. From accreditation coordination to technical execution, this collaboration demonstrated GoodAV\'s ability to work at an international level and navigate complex logistical environments during the 13th IAS Conference on HIV Science (July 13–17, 2025).',
            challenge: 'The project required providing a skilled, locally based media team for a major global health event while assisting with international media accreditation through both the IAS Society and Rwandan Media Council. Key challenges included coordinating with Plus Life Media\'s team across time zones during a tight production window, navigating uncertain local accreditation requirements that varied based on nationality and press status, and ensuring seamless integration between U.S.-based technical teams and local Rwandan crew members.',
        ...
        testimonial: {
            text: 'The GoodAV team was incredible to work with—professional, responsive, and totally in tune with the needs of an international production. From accreditation to delivery, they handled every detail on the ground in Kigali.',
            author: 'Karl Schmid',
            role: 'Co-Founder, Plus Life Media'
        }
    },
    'miss-rwanda-inspiration-backup': {
        id: 'miss-rwanda-inspiration-backup',
        slug: 'miss-rwanda-inspiration-backup',
        title: 'Miss Rwanda – Rwanda Inspiration Backup',
        description: 'Comprehensive end-to-end audiovisual production for Rwanda\'s premier cultural and beauty pageant, covering regional selections, boot camp, and grand finale',
        location: 'Rwanda (All Provinces + Kigali City)',
        tags: ['Full Production', 'Cultural Event', 'Pageant', 'B2C', 'Live Event', 'Multi-Camera', 'National Coverage'],
        youtubeUrls: [
            'https://www.youtube.com/watch?v=vJvAXgnQplk&t=3678s',
            'https://youtu.be/92XGK353E_E'
        ],
        content: {
            overview: 'Miss Rwanda is the nation\'s premier cultural and beauty pageant, celebrating intelligence, creativity, and leadership among Rwandan young women. Rwanda Inspiration Backup, the official organizer of Miss Rwanda, partnered with GoodAV as the exclusive production company to manage end-to-end audiovisual coverage of the pageant. From the early selection rounds across Rwanda\'s five regions to the final crowning ceremony, GoodAV executed a full production workflow that covered pre-production planning, live event coverage, post-production storytelling, and nationwide marketing campaigns.',
            challenge: 'Managing a comprehensive multi-stage production across all of Rwanda\'s provinces presented significant challenges: delivering high-quality, cinematic coverage from regional selections to the crowning night while ensuring consistent branding and storytelling throughout all stages, producing content that drives national engagement while highlighting contestants\' diverse personalities, talents, and aspirations, coordinating complex logistics across Eastern, Northern, Southern, Western Provinces, and Kigali City, and creating post-event promotional assets for the new Miss Rwanda to support her advocacy campaigns and international representation.',
...
var getFeaturedCaseStudies = function () {
    return [
        ...
        exports.caseStudies['gilead-ias-2025'],
        exports.caseStudies['plus-life-media-ias-2025'],
        // Major National Events & Government Projects
        exports.caseStudies['miss-rwanda-inspiration-backup'],
        exports.caseStudies['kwibuka30-rwanda-despair-to-hope'],
        exports.caseStudies['rssb-mou-signing'],
        // Educational & Research Institutions
        exports.caseStudies['alu-africa-business-heroes-2023'],
        exports.caseStudies['aims-research-innovation-centre'],
        exports.caseStudies['biomex-uvu-bio'],
        exports.caseStudies['undp-youth-cafe'],
        // Corporate & Industrial Projects
        exports.caseStudies['rwanda-rising-cimerwa-documentary'],
        exports.caseStudies['aspire-programme-year-three'],
        exports.caseStudies['snv-clean-cooking'],
        // Digital & Social Media Content
        exports.caseStudies['gilead-short-form-content']
    ];
};
exports.getFeaturedCaseStudies = getFeaturedCaseStudies;
var getCaseStudyById = function (id) {
    return exports.caseStudies[id];
};
