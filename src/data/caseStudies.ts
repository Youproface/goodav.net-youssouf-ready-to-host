...
export const getFeaturedCaseStudies = (): CaseStudyData[] => {
  return [
    ...
    caseStudies['gilead-ias-2025'],
    caseStudies['plus-life-media-ias-2025'],
    
    // Major National Events & Government Projects
    caseStudies['miss-rwanda-inspiration-backup'],
    caseStudies['kwibuka30-rwanda-despair-to-hope'],
    caseStudies['rssb-mou-signing'],
    
    // Educational & Research Institutions
    caseStudies['alu-africa-business-heroes-2023'],
    caseStudies['aims-research-innovation-centre'],
    caseStudies['biomex-uvu-bio'],
    caseStudies['undp-youth-cafe'],
    
    // Corporate & Industrial Projects
    caseStudies['rwanda-rising-cimerwa-documentary'],
    caseStudies['aspire-programme-year-three'],
    caseStudies['snv-clean-cooking'],
    
    // Digital & Social Media Content
    caseStudies['gilead-short-form-content']
  ];
};
