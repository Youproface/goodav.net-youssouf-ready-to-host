        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center 
          ...
          <div className="bg-[#1b1b1d] w-[90%] max-w-3xl rounded-xl shadow-lg text-white p-6 md:p-8  mx-auto">
            ...
            <div className="mt-6">
              ...
              {step === 6 && <Step6 submitStatus={submitStatus} handleFormSubmit={handleFormSubmit} name={name} setName={setName} email={email} setEmail={setEmail} phone={phone} setPhone={setPhone} organization={organization} setOrganization={setOrganization} project={project} setProject={setProject} selectedDate={selectedDate} setSelectedDate={setSelectedDate} selectedTime={selectedTime} setSelectedTime={setSelectedTime} timezone={timezone} setTimezone={setTimezone} submitting={submitting} />}
            </div>
