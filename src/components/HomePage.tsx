...
const HomePage: React.FC = () => {
	return (
		<>
			...
			/>
			<main className="homepage-main" role="main" aria-label="GoodAV Homepage Main Content">
				<section className="hero-section">
					...
					<ul className="seo-keywords-list text-sm mb-6">
						...
						<a href="/contact" className="cta-button bg-primary text-primary-foreground px-6 py-3 rounded-lg font-semibold shadow-glow transition-all duration-300 focus:outline focus:outline-2 focus:outline-orange-400" tabIndex={0}>Start Your Project</a>
				</section>
