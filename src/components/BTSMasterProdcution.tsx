        ...
        <section className="relative mx-auto max-w-6xl px-6 pb-16">
          ...
          <div className="mt-6 grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
            {[
              ...
              { src: "/images/all_site_images/Home/BTS/GOODAV_BTS_7v.jpg", className: "col-span-2 h-44" },
              { src: "/images/all_site_images/Home/BTS/GOODAV_BTS_8v.jpg", className: "col-span-2 h-44" },
              { src: "/images/all_site_images/Home/BTS/GOODAV_BTS_9v.jpg", className: "col-span-2 h-44" },
              { src: "/images/all_site_images/Home/BTS/GOODAV_BTS_10v.jpg", className: "col-span-2 h-44" },
              { src: "/images/all_site_images/Home/BTS/GOODAV_BTS_11v.jpg", className: "col-span-2 h-44" },
              { src: "/images/all_site_images/Home/BTS/GOODAV_BTS_12v.jpg", className: "col-span-2 h-44" },
            ].map((img, index) => (
              <GalleryImg 
                key={index}
                src={img.src}
