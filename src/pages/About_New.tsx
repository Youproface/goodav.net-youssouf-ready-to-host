  ...
  return (
    <>
      ...
      <main className="bg-[#0f1012] text-zinc-100 min-h-screen about-grayscale">
        ...
        {/* About Us Section */}
        <section aria-labelledby="about-us" className="mt-12 mx-auto max-w-6xl px-4">
          <div className="rounded-2xl border border-white/10 bg-white/3 p-8">
            <div className="text-center mb-8">
              <h2 id="about-us" className="text-3xl md:text-4xl font-bold text-white mb-4">About Us</h2>
            ...
            <div className="prose prose-lg prose-invert max-w-none">
              ...
              <div className="mt-8 p-6 bg-gradient-to-r from-orange-500/10 to-amber-400/10 rounded-xl border border-orange-500/20">
                <h3 className="text-xl font-bold text-orange-300 mb-3">EMPOWERING STORIES, CREATING CONNECTIONS</h3>
              ...
              <blockquote className="mt-8 text-center">
                <p className="text-xl md:text-2xl font-medium text-orange-200 italic leading-relaxed">
        ...
        <section aria-labelledby="services" className="mt-8 mx-auto max-w-6xl px-4">
          <div className="rounded-2xl border border-white/10 bg-white/3 p-8">
            <div className="text-center mb-8">
              <h2 id="services" className="text-3xl md:text-4xl font-bold text-white mb-4">Our Services & Mission</h2>
              <div className="h-1 w-24 bg-gradient-to-r from-orange-500 to-amber-400 mx-auto rounded-full"></div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="bg-white/5 p-6 rounded-xl">
                <h3 className="text-xl font-bold text-orange-300 mb-4">Services we provide</h3>
                <div className="grid grid-cols-2 gap-3 text-sm">
                  <div className="bg-orange-500/10 p-3 rounded text-center border border-orange-500/20">VIDEO PRODUCTION</div>
                  <div className="bg-orange-500/10 p-3 rounded text-center border border-orange-500/20">PHOTOGRAPHY</div>
                  <div className="bg-orange-500/10 p-3 rounded text-center border border-orange-500/20">LIVE STREAMING</div>
                  <div className="bg-orange-500/10 p-3 rounded text-center border border-orange-500/20">AUDIO PRODUCTION</div>
                  <div className="bg-orange-500/10 p-3 rounded text-center border border-orange-500/20">SOUND SYSTEM</div>
                  <div className="bg-orange-500/10 p-3 rounded text-center border border-orange-500/20">LIGHTING</div>
                </div>
              </div>

              {/* Foundation */}
              <div className="bg-white/5 p-6 rounded-xl">
                <h3 className="text-xl font-bold text-orange-300 mb-4">Our Foundation</h3>
                <p className="text-zinc-300 mb-4 italic">Built on purpose, driven by passion, defined by excellence</p>
                <div className="space-y-3">
                  <div>
                    <h4 className="font-semibold text-orange-200">Cultural Authenticity</h4>
                    <p className="text-sm text-zinc-400">Preserving Africa's rich heritage through genuine storytelling</p>
                  </div>
                  <div>
                    <h4 className="font-semibold text-orange-200">Technical Excellence</h4>
                    <p className="text-sm text-zinc-400">World-class production standards and cutting-edge technology</p>
                  </div>
                  <div>
                    <h4 className="font-semibold text-orange-200">Global Standards</h4>
                    <p className="text-sm text-zinc-400">Meeting international benchmarks while honoring local contexts</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="mt-8 space-y-8">
              <div className="bg-gradient-to-r from-orange-500/10 to-amber-400/10 p-8 rounded-xl border border-orange-500/20">
                <h3 className="text-2xl font-bold text-orange-300 mb-4">MISSION - EMPOWERING AFRICAN VOICES</h3>
              ...
              <div className="bg-gradient-to-r from-amber-500/10 to-orange-400/10 p-8 rounded-xl border border-amber-500/20">
                <h3 className="text-2xl font-bold text-amber-300 mb-4">VISION - AFRICA'S PREMIER STORYTELLERS</h3>
                <p className="text-zinc-300 text-lg leading-relaxed mb-6">
                ...
                <div className="grid md:grid-cols-3 gap-4 mt-6">
                  <div className="text-center">
                    <h4 className="font-bold text-amber-200">Industry Leadership</h4>
                    <p className="text-sm text-zinc-400">Setting new standards for African audiovisual excellence</p>
                  </div>
                  <div className="text-center">
                    <h4 className="font-bold text-amber-200">Global Impact</h4>
                    <p className="text-sm text-zinc-400">Creating content that resonates worldwide and drives change</p>
                  </div>
                  <div className="text-center">
                    <h4 className="font-bold text-amber-200">Cultural Bridge</h4>
                    <p className="text-sm text-zinc-400">Connecting African stories with global audiences authentically</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section aria-labelledby="team" className="mt-10 mx-auto max-w-6xl px-4">
          <div className="rounded-2xl border border-white/10 bg-white/3 p-8">
            <div className="text-center mb-8">
              <h2 id="team" className="text-3xl md:text-4xl font-bold text-white mb-4">Meet the Team</h2>
              <div className="h-1 w-24 bg-gradient-to-r from-orange-500 to-amber-400 mx-auto rounded-full"></div>
            </div>
        ...
        <section className="mx-auto max-w-6xl px-4 py-12">
          <div className="rounded-2xl border border-white/10 bg-white/3 p-8 text-center">
            <h2 className="text-2xl font-bold text-white mb-6">Ready to Start Your Story?</h2>
