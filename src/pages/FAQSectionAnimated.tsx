      ...
      <>
        ...
        <div className="absolute inset-0">
          <img
            src={heroBackground}
            alt="About GoodAV"
            className="w-full h-full object-cover opacity-30 hero-bg"
          />
        ...
        <div className="relative max-w-6xl mx-auto text-center">
          <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r text-white bg-clip-text text-transparent animate-fade-in-up animation-delay-300">
            Frequently Asked Questions
          </h1>
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto animate-fade-in-up animation-delay-600">
        ...
        <section className="relative mx-auto max-w-4xl px-6 py-10">
          <div className="text-3xl text-center font-extrabold uppercase tracking-wider text-orange-300 animate-fade-in-up animation-delay-900">
            Frequently Asked Questions
          </div>
          <h2 className="mt-2 text-h2 md:text-display leading-tight text-center animate-fade-in-up animation-delay-1200">
            The Most Questions We Had
          </h2>
          <p className="mt-2 max-w-3xl mx-auto text-body text-zinc-300 animate-fade-in-up animation-delay-1500">
            Answers to the most common questions about GoodAV's services to help make informed decisions.
          </p>
  
          {/* Accordion group */}
          <div className="mt-6 space-y-3 animate-fade-in-up animation-delay-1800">
            {/* Item 1 (expanded example) */}
            <details open className="overflow-hidden rounded-xl ring-1 ring-white/10 bg-white/5 backdrop-blur faq-accordion animate-scale-in faq-item-1">
              <summary className="flex cursor-pointer list-none items-center justify-between gap-4 px-4 py-3 text-md font-semibold hover:bg-white/5">
                ...
                <span className="text-orange-300 faq-arrow">▾</span>
              </summary>
              <div className="border-t border-white/10 px-4 py-4 text-body text-zinc-300 faq-content">
            ...
            {/* Item 2 */}
            <details className="overflow-hidden rounded-xl ring-1 ring-white/10 bg-white/5 backdrop-blur faq-accordion animate-scale-in faq-item-2">
              <summary className="flex cursor-pointer list-none items-center justify-between gap-4 px-4 py-3 text-md font-semibold hover:bg-white/5">
            ...
            {/* Item 3 */}
            <details className="overflow-hidden rounded-xl ring-1 ring-white/10 bg-white/5 backdrop-blur faq-accordion animate-scale-in faq-item-3">
              <summary className="flex cursor-pointer list-none items-center justify-between gap-4 px-4 py-3 text-md font-semibold hover:bg-white/5">
            ...
            {/* Item 4 */}
            <details className="overflow-hidden rounded-xl ring-1 ring-white/10 bg-white/5 backdrop-blur faq-accordion animate-scale-in faq-item-4">
              <summary className="flex cursor-pointer list-none items-center justify-between gap-4 px-4 py-3 text-md font-semibold hover:bg-white/5">
            ...
            {/* Item 5 */}
            <details className="overflow-hidden rounded-xl ring-1 ring-white/10 bg-white/5 backdrop-blur faq-accordion animate-scale-in faq-item-5">
              <summary className="flex cursor-pointer list-none items-center justify-between gap-4 px-4 py-3 text-md font-semibold hover:bg-white/5">
            ...
            {/* Item 6 */}
            <details className="overflow-hidden rounded-xl ring-1 ring-white/10 bg-white/5 backdrop-blur faq-accordion animate-scale-in faq-item-6">
              <summary className="flex cursor-pointer list-none items-center justify-between gap-4 px-4 py-3 text-md font-semibold hover:bg-white/5">
          ...
          {/* Help CTA */}
          <div className="mt-8 rounded-2xl ring-1 ring-white/10 bg-white/5 backdrop-blur p-5 flex items-center justify-between flex-col gap-3 sm:flex-row cta-section animate-fade-in-up animation-delay-1800">
            ...
            <div className="flex items-center gap-3">
              <a
                href="/contact"
                className="rounded-md bg-gradient-to-r from-orange-500 to-amber-400 px-4 py-2 text-mdall font-semibold text-zinc-900 shadow hover:from-orange-400 hover:to-amber-300 cta-button"
              >
                Contact Us
              </a>
              <a
                href="/portfolio"
                className="rounded-md border border-white/10 bg-white/5 px-4 py-2 text-mdall text-zinc-200 hover:bg-white/10 cta-button"
              >
                Explore Portfolio
              </a>
            </div>
